 ...
 */
class SmartSitemapExtension extends Extension
{
    /**
     * {@inheritDoc}
     */
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $container->setParameter('smart_sitemap.target',    $config['target'] ? $config['target'] : $container->getParameter('kernel.project_dir').'/web');
